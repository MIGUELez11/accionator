...
export async function StockHeader({ symbol, name, logo, price, change, percentChange }: StockHeaderProps) {
  return (
    <div>
    <div className="flex flex-row gap-2 min-w-full justify-between p-4">
      <div className="flex flex-row gap-2 items-center">
        <img src={logo} alt={name + " logo"} className="w-12 h-12 rounded-sm" />
